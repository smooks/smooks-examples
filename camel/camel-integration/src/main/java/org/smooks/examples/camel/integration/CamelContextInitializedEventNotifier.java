...
public class CamelContextInitializedEventNotifier extends EventNotifierSupport {
    @Override
    public void notify(CamelEvent event) {
        if (event instanceof CamelEvent.CamelContextInitializedEvent) {
            getCamelContext().getRegistry().bind(SmooksFactory.class.getName(), new CamelSmooksFactory());
        }
    }
}
