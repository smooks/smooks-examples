/*-
 * ========================LICENSE_START=================================
 * Smooks Camel UNEDIFACT to String
 * %%
 ...
 * =========================LICENSE_END==================================
 */
package org.smooks.examples.camel.unedifact2xml;
...
public class StartStopEventNotifier extends EventNotifierSupport {
    ...
    private final CountDownLatch StartStopEventNotifier = new CountDownLatch(1);
    ...
    public void notify(CamelEvent event) {
        if (event instanceof CamelEvent.CamelContextInitializedEvent) {
            ...
            StartStopEventNotifier.countDown();
        }
    }

    public void waitUntilFinish() throws InterruptedException {
        StartStopEventNotifier.await();
    }
}
