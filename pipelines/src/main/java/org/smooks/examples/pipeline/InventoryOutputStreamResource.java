...
public class InventoryOutputStreamResource extends AbstractOutputStreamResource {
    public static final ByteArrayOutputStream INVENTORY_OUTPUT_STREAM = new ByteArrayOutputStream();
    @Override
    public OutputStream getOutputStream(ExecutionContext executionContext) throws IOException {
        return INVENTORY_OUTPUT_STREAM;
    }
